# 🏨 Property Management System (PMS) – Hotel

🔗 **Live Demo (Frontend):** https://pms-hotel-fe.vercel.app  
🔗 **API (Backend):** https://pms-hotel-production.up.railway.app
...
- Menjadi pondasi untuk pengembangan PMS yang lebih lengkap
...
- **express-validator**
- **helmet** & **rate-limit** (basic security)
- **winston** (logging)
